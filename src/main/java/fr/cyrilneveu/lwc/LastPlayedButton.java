...
public class LastPlayedButton extends GuiButton {
    private static final ResourceLocation LAST_PLAYED_BUTTON = new ResourceLocation(LastWorldCharger.MOD_ID, "textures/gui/last_played_button.png");
    private static final ResourceLocation LAST_PLAYED_BUTTON_HOVERED = new ResourceLocation(LastWorldCharger.MOD_ID, "textures/gui/last_played_button_hovered.png");
